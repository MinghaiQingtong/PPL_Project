...
| :-----: | :----------------------------------------------------------: | :------------: | :------------: | :---------: |
|    0    |              while(-x+y<=0, -x-y+1<=0) y=y-2x+1              |       U        |       F        |      U      |
|    1    |              while(-x+y<=0, -x-y<=-1) y=y-2x+1               |       U        |       F        |      U      |
|    6    |             while(q>=1) q=q+a-1 a=3a-4b, b=4a+3b             |       U        |       U        |      U      |
|    9    |                      while(x>=0) x=x-y                       |       U        |       F        |      F      |
|   10    |                    while(x>=0, y=0) x=x-c                    |       U        |       F        |      F      |
|   11    |                   while(x>=23) x=x-c, c=c                    |       U        |       F        |      F      |
|   12    |                      while(x>=0) x=x-y                       |       U        |       F        |      F      |
...
| **55**  |         **while(x>=0, y>=0, z+x>=0) y=y-x, z=z+x-2**         |     **U**      |     **F**      |    **U**    |
|   60    |                while(x>=0) x=x-y, y=y-z, z=-z                |       U        |       F        |      F      |
|   61    |                while(y<=6,x>=0) y=-y+7, x=x-y                |       T        |       T        |      T      |
|   63    |                 while(2x+y>=0) x=x-c, y=y+c                  |       U        |       F        |      F      |
|   65    |             while(z>=0) x=y-c, y=x, z=z+x+y-a+b              |       U        |       F        |      F      |
|   66    |                  while(q>=1) q=q+z-1, z=-z                   |       T        |       T        |      T      |
|   67    |              while(q>=0) q=q+z-y-1, y=-y, z=-z               |       T        |       T        |      T      |
|   68    |          while(q>=1) q=q+a-1, 10a=6a-8b, 10b=8a+6b           |       T        |       T        |      T      |
|   70    |                while(x>=1, y>=1) x=x-i, y=y+i                |       U        |       F        |      F      |
|   72    |                  while(x+c>=0) x=x-c, c=c+1                  |       U        |       U        |      T      |
|   73    |                   while(x>=b) x=x-d, d=d+2                   |       U        |       U        |      F      |
...
|   97    |                 while(x>=0) x=2x+3y, y=7y+11                 |       U        |       F        |      F      |
|   98    |             while(z>=1, y<=-1) x=3x, y=2y, z=x+y             |       U        |       U        |      U      |
|   99    |             while(z>=0) x=x+y, y=y-x+1, z=z+x+1              |       U        |       U        |      F      |
...
| **122** |                  **while(x>=0) x=x+a-b-1**                   |     **U**      |     **F**      |    **U**    |
|   123   |                      while(x>=0) x=x-c                       |       U        |       F        |      F      |
...
|   140   |                 while(x>=0) z=y, y=2y-x, x=z                 |       U        |       F        |      F      |
